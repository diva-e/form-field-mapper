...
public class FormDataListMappingStrategy implements MappingStrategy {
	...
	<O> void map(final Collection<O> objects, final FormDataList formDataList, final Language language){
		for(final O object : objects) {
			...
			final IdProvidingFormData idProvidingFormData = FORM_DATA_LIST_SERVANT.createIdProvidingFormData(formDataList, templateUid);
